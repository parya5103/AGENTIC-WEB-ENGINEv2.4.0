      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-gray-100 px-8 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-4">
             ...
             <button onClick={logoutFromApp} aria-label="Logout" className="p-2.5 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all"><LogOut className="w-5 h-5" /></button>
          </div>
        </header>
                                ...
                                <div key={cat.slug} className="p-6 rounded-3xl border border-gray-100 hover:border-blue-200 transition-all group bg-gray-50/30 overflow-hidden relative">
                                    ...
                                    <div className="flex items-center justify-between border-t border-gray-100 pt-4 gap-4">
                                      ...
                                      <div className="flex items-center gap-2">
                                        <button onClick={() => handleRefresh(cat.slug)} aria-label="Refresh Content" className="p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all" title="Refresh Content">
                                          <RefreshCcw className="w-4 h-4" />
                                        </button>
                                        <button onClick={() => handleDelete(cat.slug)} aria-label="Delete Node" className="p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all" title="Delete Node">
