...
export const generateEmpireHtml = (category: any, posts: any[] = [], post?: any) => {
  ...
  const colors = category?.style?.primaryColor ? { primary: escapeHtml(category.style.primaryColor), accent: escapeHtml(category.style.accentColor || category.style.primaryColor), background: "#FFFFFF" } : { primary: "#000000", accent: "#000000", background: "#FFFFFF" };
